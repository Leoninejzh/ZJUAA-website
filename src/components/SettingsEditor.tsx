...
const FIELDS: {
  ...
  { key: "zelleQrImageUrl", label: "Zelle 二维码图片 URL（留空则自动生成）", type: "text", placeholder: "/assets/xxx.png 或完整图片链接" },
  { key: "zeffyDonationUrl", label: "Zeffy 捐赠页面链接", type: "text", placeholder: "https://www.zeffy.com/..." },
  { key: "zeffyQrImageUrl", label: "Zeffy 二维码图片 URL（留空则根据链接自动生成）", type: "text", placeholder: "/assets/xxx.png 或完整图片链接" },
